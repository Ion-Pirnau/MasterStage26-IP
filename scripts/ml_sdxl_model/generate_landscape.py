...
def generate_landscape():
    ...
    # 2. Scheduler ottimizzato per velocità
    ...
    if os.path.exists(lora_folder_path):
        ...
        # fuse_lora "fonde" fisicamente la matematica del LoRA dentro la UNet.
        # È molto più potente e stabile di set_adapters() per la generazione incondizionata.
